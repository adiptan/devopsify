...
- **Карусель карточек** по 10 темам: Nginx (10 карточек), Bash (15), Kubernetes (10), Git (10), Docker (10), TCP/IP (5), systemd (5), Network Utils (5), Linux Files (5), HTTP Methods (5)
- **Навигация:** ⬅️ Предыдущая / ➡️ Следующая
- **Быстрый переход:** `/nginx 5`, `/bash 10`, `/k8s 3`, `/git 7`, `/docker 4`, `/tcpip 2`, `/systemd 3`, `/network 1`, `/linuxfiles 4`, `/http 2`
...
- **TCP/IP** (5 задач)
- **systemd** (5 задач)
- **Network Utils** (5 задач)
- **Linux Files** (5 задач)
- **HTTP Methods** (5 задач)
...
- `/tcpip [N]` — Перейти к N-й карточке TCP/IP ✨
- `/systemd [N]` — Перейти к N-й карточке systemd ✨
- `/network [N]` — Перейти к N-й карточке Network Utils ✨
- `/linuxfiles [N]` — Перейти к N-й карточке Linux Files ✨
- `/http [N]` — Перейти к N-й карточке HTTP Methods ✨
